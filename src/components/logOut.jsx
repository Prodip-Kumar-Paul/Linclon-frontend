...
const LogOut = () => {
  ...
  return (
    <>
      <section className="font-bold rounded-[.5rem] px-3 py-5 max-w-[25rem] mx-auto my-[5rem] bg-white dark:bg-gradient-to-r dark:from-[rgb(50,50,50)] dark:to-[rgb(40,40,40)] dark:text-white text-lg text-center">
        <div>
